...
public class User {
  ...
  //  @property (nonatomic, retain) NSString *isOnline;
    ...
    public String getProfileImage250() {
        return profileImage250;
    }

    public void setProfileImage250(String profileImage250) {
        this.profileImage250 = profileImage250;
    }
    ...
    public int getSignUpComplete() {
        return isSignUpComplete;
    }

    public void setSignUpComplete(int signUpComplete) {
