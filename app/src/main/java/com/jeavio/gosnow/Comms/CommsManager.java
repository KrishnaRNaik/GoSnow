...
public class CommsManager {
    ...
    public CommsResult AddPhoto(User user, Context context)
    {
        ...
        try {
            ...
            Bitmap bitmap = null;
            try {
                profileImageUrl = new URL("https://graph.facebook.com/" + /*user.getFacebookId()*/ "135906693515634"+ "/picture?width=400&height=400");
            } catch (MalformedURLException e) {
                e.printStackTrace();
            }
            try {
            ...
            obj.put(BusinessConsts.ADDPHOTO_IMAGE,bitmap);
